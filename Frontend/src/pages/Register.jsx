...
const Register = () => {
  ...
  const { register, signInWithGoogle, loading, error, isAuthenticated, clearError } = useAuth();
  ...
  const validateField = (name, value, allData = formData) => {
    switch (name) {
      ...
      case 'confirmPassword':
        return value === allData.password && value.length > 0;
      default:
        return false;
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Join Article App</h1>
          <p className="text-gray-500">Create your account to start writing</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="relative">
              ...
              <input
                ...
                disabled={loading}
              />
              {formData.name && getFieldValidation('name') && (
            ...
            <div className="relative">
              ...
              <input
                ...
                disabled={loading}
              />
              {formData.email && getFieldValidation('email') && (
                <div className="absolute inset-y-0 right-0 pr-4 flex items-center">
                  <Check className="w-5 h-5 text-green-500" />
                </div>
              )}
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full pl-12 pr-20 py-4 bg-gray-50 border-0 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all duration-200 placeholder-gray-400 text-gray-900"
              ...
              <div className="absolute inset-y-0 right-0 flex items-center">
                {formData.password && getFieldValidation('password') && (
            ...
            <div className="relative">
              ...
              />
              <div className="absolute inset-y-0 right-0 flex items-center">
                {formData.confirmPassword && getFieldValidation('confirmPassword') && (
                  <Check className="w-5 h-5 text-green-500 mr-2" />
                )}
                <button
                  type="button"
